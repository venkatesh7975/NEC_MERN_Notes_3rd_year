# Assignment: Equipment reservations

ID: course-fullstack. Status: specification ready. Estimated work: 3–4 hours of independent practice unless faculty selects a shorter subset.

## Objective

Apply integration, persistence, api contracts, verification and verify the result.

## Background

A fictional college needs equipment reservations.

## Problem statement

Book available equipment; prevent overbooking atomically.
...
1. Book available equipment.
2. prevent overbooking atomically.

## Technical requirements

Use React, Node.js, Express, MongoDB. Prerequisites: React, API, database and security tracks. See [the full project contract](../../mini-projects/fullstack/06-equipment-reservations/README.md) for UI/API/database and run requirements.
...
Two requests for last item allow one success.
