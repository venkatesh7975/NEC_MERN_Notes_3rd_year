# Assignment: Filter and sort API

ID: course-rest-api. Status: specification ready. Estimated work: 3–4 hours of independent practice unless faculty selects a shorter subset.

## Objective

Apply resources, methods, status codes, statelessness and verify the result.

## Background

A fictional college needs filter and sort api.

## Problem statement

Allowlist sort fields; filter before pagination.
...
1. Allowlist sort fields.
2. filter before pagination.

## Technical requirements

Use HTTP, Node.js, Express. Prerequisites: Express routes. See [the full project contract](../../mini-projects/rest-api/06-filter-and-sort-api/README.md) for UI/API/database and run requirements.
...
Filtered results keep stable ordering.
