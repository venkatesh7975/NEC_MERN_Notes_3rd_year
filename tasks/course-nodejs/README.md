# Assignment: Parallel resource loader

ID: course-nodejs. Status: specification ready. Estimated work: 3–4 hours of independent practice unless faculty selects a shorter subset.

## Objective

Apply module system, npm, asynchronous programming, events and verify the result.

## Background

A fictional college needs parallel resource loader.

## Problem statement

Read three files with allSettled; retain successful results.
...
1. Read three files with allSettled.
2. retain successful results.

## Technical requirements

Use Node.js, JavaScript. Prerequisites: JavaScript functions and promises. See [the full project contract](../../mini-projects/nodejs/06-parallel-resource-loader/README.md) for UI/API/database and run requirements.
...
One missing file does not discard two successes.
