# Assignment: Object access review

ID: course-security. Status: specification ready. Estimated work: 3–4 hours of independent practice unless faculty selects a shorter subset.

## Objective

Apply owasp basics, sql injection, xss, csrf and verify the result.

## Background

A fictional college needs object access review.

## Problem statement

Check ownership for reads and writes; use two fictional accounts.
...
1. Check ownership for reads and writes.
2. use two fictional accounts.

## Technical requirements

Use JavaScript, HTTP, SQL. Prerequisites: Forms, HTTP and databases. See [the full project contract](../../mini-projects/security/06-object-access-review/README.md) for UI/API/database and run requirements.
