...
ID: MONGOOSE-04. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement query update validation. Explain the acceptance example from input to result.

## Problem Statement

Build query update validation for a fictional college environment. Enable update validators; test positive and negative changes.
...
1. FR-1: Enable update validators. Demonstrate with a reproducible fixture.
2. FR-2: test positive and negative changes. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Negative update fails.

## Expected Output

Negative update fails. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: enable update validators. For an industry exercise, write a recovery and handoff note identifying operational limits.
