...
ID: MONGOOSE-08. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement schema migration rehearsal. Explain the acceptance example from input to result.

## Problem Statement

Build schema migration rehearsal for a fictional college environment. Add versioned optional field; backfill sandbox; verify counts.

## Features

- Add versioned optional field.
- backfill sandbox.
- verify counts.

## Functional Requirements

1. FR-1: Add versioned optional field. Demonstrate with a reproducible fixture.
2. FR-2: backfill sandbox. Demonstrate with a reproducible fixture.
3. FR-3: verify counts. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Old documents remain readable.

## Expected Output

Old documents remain readable. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: add versioned optional field. For an industry exercise, write a recovery and handoff note identifying operational limits.
