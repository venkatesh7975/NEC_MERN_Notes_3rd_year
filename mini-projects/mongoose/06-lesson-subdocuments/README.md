...
ID: MONGOOSE-06. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement lesson subdocuments. Explain the acceptance example from input to result.

## Problem Statement

Build lesson subdocuments for a fictional college environment. Validate lesson titles and a maximum array length.

## Features

- Validate lesson titles and a maximum array length.

## Functional Requirements

1. FR-1: Validate lesson titles and a maximum array length. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Maximum plus one lesson fails.

## Expected Output

Maximum plus one lesson fails. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate lesson titles and a maximum array length. For an industry exercise, write a recovery and handoff note identifying operational limits.
