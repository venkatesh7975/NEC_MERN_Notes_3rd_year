...
ID: MONGOOSE-05. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement instructor references. Explain the acceptance example from input to result.

## Problem Statement

Build instructor references for a fictional college environment. Populate public fields; handle a deleted reference.

## Features

- Populate public fields.
- handle a deleted reference.

## Functional Requirements

1. FR-1: Populate public fields. Demonstrate with a reproducible fixture.
2. FR-2: handle a deleted reference. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Missing instructor does not crash output.

## Expected Output

Missing instructor does not crash output. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: populate public fields. For an industry exercise, write a recovery and handoff note identifying operational limits.
