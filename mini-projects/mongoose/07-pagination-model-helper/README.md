...
ID: MONGOOSE-07. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement pagination model helper. Explain the acceptance example from input to result.

## Problem Statement

Build pagination model helper for a fictional college environment. Validate page and limit; sort by time and ID; count matches.
...
1. FR-1: Validate page and limit. Demonstrate with a reproducible fixture.
2. FR-2: sort by time and ID. Demonstrate with a reproducible fixture.
3. FR-3: count matches. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: page=0 fails before query.

## Expected Output

page=0 fails before query. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate page and limit. For an industry exercise, write a recovery and handoff note identifying operational limits.
