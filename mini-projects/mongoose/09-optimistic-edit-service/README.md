# Optimistic edit service

ID: MONGOOSE-09. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement optimistic edit service. Explain the acceptance example from input to result.

## Problem Statement

Build optimistic edit service for a fictional college environment. Use version checks; reject stale update; support refetch.
...
1. FR-1: Use version checks. Demonstrate with a reproducible fixture.
2. FR-2: reject stale update. Demonstrate with a reproducible fixture.
3. FR-3: support refetch. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Stale writer cannot overwrite new title.

## Expected Output

Stale writer cannot overwrite new title. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: use version checks. For an industry exercise, write a recovery and handoff note identifying operational limits.
