...
ID: MONGOOSE-03. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement unique course code. Explain the acceptance example from input to result.

## Problem Statement

Build unique course code for a fictional college environment. Build unique index; separate duplicate key from validation errors.

## Features

- Build unique index.
- separate duplicate key from validation errors.

## Functional Requirements

1. FR-1: Build unique index. Demonstrate with a reproducible fixture.
2. FR-2: separate duplicate key from validation errors. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Second HTML code is rejected.

## Expected Output

Second HTML code is rejected. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: build unique index. For an industry exercise, write a recovery and handoff note identifying operational limits.
