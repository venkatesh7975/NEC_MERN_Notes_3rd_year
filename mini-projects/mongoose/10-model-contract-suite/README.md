...
ID: MONGOOSE-10. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement model contract suite. Explain the acceptance example from input to result.

## Problem Statement

Build model contract suite for a fictional college environment. Test create save query updates and unique errors separately.

## Features

- Test create save query updates and unique errors separately.

## Functional Requirements

1. FR-1: Test create save query updates and unique errors separately. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Every write path satisfies documented invariants.

## Expected Output

Every write path satisfies documented invariants. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: test create save query updates and unique errors separately. For an industry exercise, write a recovery and handoff note identifying operational limits.
