...
ID: MONGOOSE-02. Status: specification ready; solution not supplied.
...
Apply schemas, validation, indexes, references to implement defaults and timestamps. Explain the acceptance example from input to result.

## Problem Statement

Build defaults and timestamps for a fictional college environment. Set draft default and timestamps; allow explicit status.

## Features

- Set draft default and timestamps.
- allow explicit status.

## Functional Requirements

1. FR-1: Set draft default and timestamps. Demonstrate with a reproducible fixture.
2. FR-2: allow explicit status. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Missing status becomes draft.

## Expected Output

Missing status becomes draft. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: set draft default and timestamps. For an industry exercise, write a recovery and handoff note identifying operational limits.
