...
ID: DEVOPS-08. Status: specification ready; solution not supplied.
...
Apply git, github, ci/cd, docker, react deployment to implement environment separation. Explain the acceptance example from input to result.

## Problem Statement

Build environment separation for a fictional college environment. Separate public frontend and private server variables; inspect bundle.

## Features

- Separate public frontend and private server variables.
- inspect bundle.

## Functional Requirements

1. FR-1: Separate public frontend and private server variables. Demonstrate with a reproducible fixture.
2. FR-2: inspect bundle. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Fake server secret absent from frontend bundle.

## Expected Output

Fake server secret absent from frontend bundle. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: separate public frontend and private server variables. For an industry exercise, write a recovery and handoff note identifying operational limits.
