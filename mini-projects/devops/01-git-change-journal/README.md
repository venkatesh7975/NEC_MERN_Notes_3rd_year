...
ID: DEVOPS-01. Status: specification ready; solution not supplied.
...
Apply git, github, ci/cd, docker, react deployment to implement git change journal. Explain the acceptance example from input to result.

## Problem Statement

Build git change journal for a fictional college environment. Create three commits in scratch repo; explain stage and worktree.

## Features

- Create three commits in scratch repo.
- explain stage and worktree.

## Functional Requirements

1. FR-1: Create three commits in scratch repo. Demonstrate with a reproducible fixture.
2. FR-2: explain stage and worktree. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Log contains three distinct changes.

## Expected Output

Log contains three distinct changes. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: create three commits in scratch repo. For an industry exercise, write a recovery and handoff note identifying operational limits.
