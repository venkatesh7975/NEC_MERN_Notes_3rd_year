...
ID: DEVOPS-04. Status: specification ready; solution not supplied.
...
Apply git, github, ci/cd, docker, react deployment to implement merge conflict workshop. Explain the acceptance example from input to result.

## Problem Statement

Build merge conflict workshop for a fictional college environment. Create controlled conflict; resolve both intended changes.

## Features

- Create controlled conflict.
- resolve both intended changes.

## Functional Requirements

1. FR-1: Create controlled conflict. Demonstrate with a reproducible fixture.
2. FR-2: resolve both intended changes. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Final file retains required edits.

## Expected Output

Final file retains required edits. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: create controlled conflict. For an industry exercise, write a recovery and handoff note identifying operational limits.
