# Branch review exercise

ID: DEVOPS-02. Status: specification ready; solution not supplied.
...
Apply git, github, ci/cd, docker, react deployment to implement branch review exercise. Explain the acceptance example from input to result.

## Problem Statement

Build branch review exercise for a fictional college environment. Create branch; inspect diff against main; summarize review.
...
1. FR-1: Create branch. Demonstrate with a reproducible fixture.
2. FR-2: inspect diff against main. Demonstrate with a reproducible fixture.
3. FR-3: summarize review. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Diff contains only intended edit.

## Expected Output

Diff contains only intended edit. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: create branch. For an industry exercise, write a recovery and handoff note identifying operational limits.
