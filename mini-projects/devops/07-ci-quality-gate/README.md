...
ID: DEVOPS-07. Status: specification ready; solution not supplied.
...
Apply git, github, ci/cd, docker, react deployment to implement ci quality gate. Explain the acceptance example from input to result.

## Problem Statement

Build ci quality gate for a fictional college environment. Run link and build checks; demonstrate a failing fixture.

## Features

- Run link and build checks.
- demonstrate a failing fixture.

## Functional Requirements

1. FR-1: Run link and build checks. Demonstrate with a reproducible fixture.
2. FR-2: demonstrate a failing fixture. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Broken fixture fails the job.

## Expected Output

Broken fixture fails the job. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: run link and build checks. For an industry exercise, write a recovery and handoff note identifying operational limits.
