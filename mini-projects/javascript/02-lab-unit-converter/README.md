...
ID: JAVASCRIPT-02. Status: specification ready; solution not supplied.
...
Predict values, implement branching and loops, and connect logic to browser events. Apply this by building lab unit converter and explaining the acceptance example.

## Problem Statement

Build lab unit converter for a fictional college learning environment. The deliverable must demonstrate the specific behavior below using small reproducible fixtures. Use fictional records only.
...
1. FR-1: Convert Celsius to Fahrenheit and back. Provide an observation or test that proves this behavior.
2. FR-2: reject nonnumeric input. Provide an observation or test that proves this behavior.
...
Prepare the fixture or interaction in this acceptance scenario: 0 Celsius yields 32 Fahrenheit.

## Expected Output

Acceptance oracle: 0 Celsius yields 32 Fahrenheit. Record the actual result next to the expected result in your test evidence.
...
Add one contrasting fixture that stresses the main invariant: convert celsius to fahrenheit and back. Compare the two results in a short design note. For Industry projects, include operational limits and recovery steps in the handoff.

## Interview Questions

1. How does convert celsius to fahrenheit and back work in your solution?
