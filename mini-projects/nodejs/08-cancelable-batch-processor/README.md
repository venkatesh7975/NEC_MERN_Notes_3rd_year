# Cancelable batch processor

ID: NODEJS-08. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement cancelable batch processor. Explain the acceptance example from input to result.

## Problem Statement

Build cancelable batch processor for a fictional college environment. Process items in order; cancel between items.
...
1. FR-1: Process items in order. Demonstrate with a reproducible fixture.
2. FR-2: cancel between items. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Cancel after item 2 prevents item 3 starting.

## Expected Output

Cancel after item 2 prevents item 3 starting. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: process items in order. For an industry exercise, write a recovery and handoff note identifying operational limits.
