...
ID: NODEJS-03. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement json roster reader. Explain the acceptance example from input to result.

## Problem Statement

Build json roster reader for a fictional college environment. Read a file asynchronously; validate array shape; handle errors.
...
1. FR-1: Read a file asynchronously. Demonstrate with a reproducible fixture.
2. FR-2: validate array shape. Demonstrate with a reproducible fixture.
3. FR-3: handle errors. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Two records print 2; missing file exits nonzero.

## Expected Output

Two records print 2; missing file exits nonzero. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: read a file asynchronously. For an industry exercise, write a recovery and handoff note identifying operational limits.
