...
ID: NODEJS-04. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement course file organizer. Explain the acceptance example from input to result.

## Problem Statement

Build course file organizer for a fictional college environment. Group fixture filenames by extension; preserve source files.

## Features

- Group fixture filenames by extension.
- preserve source files.

## Functional Requirements

1. FR-1: Group fixture filenames by extension. Demonstrate with a reproducible fixture.
2. FR-2: preserve source files. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Three Markdown files appear in one group.

## Expected Output

Three Markdown files appear in one group. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: group fixture filenames by extension. For an industry exercise, write a recovery and handoff note identifying operational limits.
