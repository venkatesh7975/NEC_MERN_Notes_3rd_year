...
ID: NODEJS-06. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement parallel resource loader. Explain the acceptance example from input to result.

## Problem Statement

Build parallel resource loader for a fictional college environment. Read three files with allSettled; retain successful results.

## Features

- Read three files with allSettled.
- retain successful results.

## Functional Requirements

1. FR-1: Read three files with allSettled. Demonstrate with a reproducible fixture.
2. FR-2: retain successful results. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: One missing file does not discard two successes.

## Expected Output

One missing file does not discard two successes. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: read three files with allsettled. For an industry exercise, write a recovery and handoff note identifying operational limits.
