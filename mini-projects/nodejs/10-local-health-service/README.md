...
ID: NODEJS-10. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement local health service. Explain the acceptance example from input to result.

## Problem Statement

Build local health service for a fictional college environment. Serve health and version routes; return 404 elsewhere; shut down cleanly.

## Features

- Serve health and version routes.
- return 404 elsewhere.
- shut down cleanly.

## Functional Requirements

1. FR-1: Serve health and version routes. Demonstrate with a reproducible fixture.
2. FR-2: return 404 elsewhere. Demonstrate with a reproducible fixture.
3. FR-3: shut down cleanly. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Unknown path returns 404.

## Expected Output

Unknown path returns 404. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: serve health and version routes. For an industry exercise, write a recovery and handoff note identifying operational limits.
