...
ID: NODEJS-05. Status: specification ready; solution not supplied.
...
Apply module system, npm, asynchronous programming, events to implement event notification simulator. Explain the acceptance example from input to result.

## Problem Statement

Build event notification simulator for a fictional college environment. Register event listeners once; count deliveries.
...
1. FR-1: Register event listeners once. Demonstrate with a reproducible fixture.
2. FR-2: count deliveries. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: One emitted event calls each listener once.

## Expected Output

One emitted event calls each listener once. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: register event listeners once. For an industry exercise, write a recovery and handoff note identifying operational limits.
