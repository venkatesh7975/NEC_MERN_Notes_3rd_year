...
ID: REST-API-04. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement patch validation service. Explain the acceptance example from input to result.

## Problem Statement

Build patch validation service for a fictional college environment. Allow title and hours updates only; preserve omitted fields.

## Features

- Allow title and hours updates only.
- preserve omitted fields.

## Functional Requirements

1. FR-1: Allow title and hours updates only. Demonstrate with a reproducible fixture.
2. FR-2: preserve omitted fields. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Updating title leaves hours unchanged.

## Expected Output

Updating title leaves hours unchanged. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: allow title and hours updates only. For an industry exercise, write a recovery and handoff note identifying operational limits.
