...
ID: REST-API-06. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement filter and sort api. Explain the acceptance example from input to result.

## Problem Statement

Build filter and sort api for a fictional college environment. Allowlist sort fields; filter before pagination.
...
1. FR-1: Allowlist sort fields. Demonstrate with a reproducible fixture.
2. FR-2: filter before pagination. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Filtered results keep stable ordering.

## Expected Output

Filtered results keep stable ordering. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: allowlist sort fields. For an industry exercise, write a recovery and handoff note identifying operational limits.
