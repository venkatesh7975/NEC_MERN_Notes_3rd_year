# API compatibility exercise

ID: REST-API-09. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement api compatibility exercise. Explain the acceptance example from input to result.

## Problem Statement

Build api compatibility exercise for a fictional college environment. Serve v1 and v2 contracts; preserve v1 fields.

## Features

- Serve v1 and v2 contracts.
- preserve v1 fields.

## Functional Requirements

1. FR-1: Serve v1 and v2 contracts. Demonstrate with a reproducible fixture.
2. FR-2: preserve v1 fields. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Existing v1 tests still pass.

## Expected Output

Existing v1 tests still pass. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: serve v1 and v2 contracts. For an industry exercise, write a recovery and handoff note identifying operational limits.
