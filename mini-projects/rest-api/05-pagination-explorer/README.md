...
ID: REST-API-05. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement pagination explorer. Explain the acceptance example from input to result.

## Problem Statement

Build pagination explorer for a fictional college environment. Require positive page and limit; cap limit at 50; sort deterministically.

## Features

- Require positive page and limit.
- cap limit at 50.
- sort deterministically.

## Functional Requirements

1. FR-1: Require positive page and limit. Demonstrate with a reproducible fixture.
2. FR-2: cap limit at 50. Demonstrate with a reproducible fixture.
3. FR-3: sort deterministically. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: page=0 returns 400.

## Expected Output

page=0 returns 400. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: require positive page and limit. For an industry exercise, write a recovery and handoff note identifying operational limits.
