...
ID: REST-API-10. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement client contract suite. Explain the acceptance example from input to result.

## Problem Statement

Build client contract suite for a fictional college environment. Test success validation missing resources and outages; show retryable errors.

## Features

- Test success validation missing resources and outages.
- show retryable errors.

## Functional Requirements

1. FR-1: Test success validation missing resources and outages. Demonstrate with a reproducible fixture.
2. FR-2: show retryable errors. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: A 500 response becomes a visible client error.

## Expected Output

A 500 response becomes a visible client error. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: test success validation missing resources and outages. For an industry exercise, write a recovery and handoff note identifying operational limits.
