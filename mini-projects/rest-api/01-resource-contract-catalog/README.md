# Resource contract catalog

ID: REST-API-01. Status: specification ready; solution not supplied.
...
Apply resources, methods, status codes, statelessness to implement resource contract catalog. Explain the acceptance example from input to result.

## Problem Statement

Build resource contract catalog for a fictional college environment. Implement collection and item reads; document representations.

## Features

- Implement collection and item reads.
- document representations.

## Functional Requirements

1. FR-1: Implement collection and item reads. Demonstrate with a reproducible fixture.
2. FR-2: document representations. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Missing item returns 404.

## Expected Output

Missing item returns 404. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: implement collection and item reads. For an industry exercise, write a recovery and handoff note identifying operational limits.
