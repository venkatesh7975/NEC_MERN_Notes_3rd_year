...
ID: FULLSTACK-04. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement submission portal. Explain the acceptance example from input to result.

## Problem Statement

Build submission portal for a fictional college environment. Submit URL for assignment; enforce unique user-assignment pair.

## Features

- Submit URL for assignment.
- enforce unique user-assignment pair.

## Functional Requirements

1. FR-1: Submit URL for assignment. Demonstrate with a reproducible fixture.
2. FR-2: enforce unique user-assignment pair. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Duplicate submission returns conflict.

## Expected Output

Duplicate submission returns conflict. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: submit url for assignment. For an industry exercise, write a recovery and handoff note identifying operational limits.
