...
ID: FULLSTACK-06. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement equipment reservations. Explain the acceptance example from input to result.

## Problem Statement

Build equipment reservations for a fictional college environment. Book available equipment; prevent overbooking atomically.

## Features

- Book available equipment.
- prevent overbooking atomically.

## Functional Requirements

1. FR-1: Book available equipment. Demonstrate with a reproducible fixture.
2. FR-2: prevent overbooking atomically. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Two requests for last item allow one success.

## Expected Output

Two requests for last item allow one success. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: book available equipment. For an industry exercise, write a recovery and handoff note identifying operational limits.
