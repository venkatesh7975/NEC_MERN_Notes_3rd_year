...
ID: FULLSTACK-05. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement faculty course editor. Explain the acceptance example from input to result.

## Problem Statement

Build faculty course editor for a fictional college environment. Protect editing route; validate title/hours server-side.

## Features

- Protect editing route.
- validate title/hours server-side.

## Functional Requirements

1. FR-1: Protect editing route. Demonstrate with a reproducible fixture.
2. FR-2: validate title/hours server-side. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Learner cannot edit course.

## Expected Output

Learner cannot edit course. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: protect editing route. For an industry exercise, write a recovery and handoff note identifying operational limits.
