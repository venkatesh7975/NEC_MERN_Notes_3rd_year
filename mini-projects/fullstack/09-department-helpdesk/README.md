...
ID: FULLSTACK-09. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement department helpdesk. Explain the acceptance example from input to result.

## Problem Statement

Build department helpdesk for a fictional college environment. Assign tickets to staff; restrict visibility; paginate and filter.
...
1. FR-1: Assign tickets to staff. Demonstrate with a reproducible fixture.
2. FR-2: restrict visibility. Demonstrate with a reproducible fixture.
3. FR-3: paginate and filter. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Students see only their own tickets.

## Expected Output

Students see only their own tickets. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: assign tickets to staff. For an industry exercise, write a recovery and handoff note identifying operational limits.
