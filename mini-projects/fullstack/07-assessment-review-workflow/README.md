...
ID: FULLSTACK-07. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement assessment review workflow. Explain the acceptance example from input to result.

## Problem Statement

Build assessment review workflow for a fictional college environment. Enforce submitted reviewed returned transitions; keep feedback history.

## Features

- Enforce submitted reviewed returned transitions.
- keep feedback history.

## Functional Requirements

1. FR-1: Enforce submitted reviewed returned transitions. Demonstrate with a reproducible fixture.
2. FR-2: keep feedback history. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Invalid transition rejected.

## Expected Output

Invalid transition rejected. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: enforce submitted reviewed returned transitions. For an industry exercise, write a recovery and handoff note identifying operational limits.
