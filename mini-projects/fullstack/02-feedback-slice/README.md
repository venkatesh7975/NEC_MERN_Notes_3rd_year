...
ID: FULLSTACK-02. Status: specification ready; solution not supplied.
...
Apply integration, persistence, api contracts, verification to implement feedback slice. Explain the acceptance example from input to result.

## Problem Statement

Build feedback slice for a fictional college environment. Validate rating on server; save feedback; show confirmed receipt.

## Features

- Validate rating on server.
- save feedback.
- show confirmed receipt.

## Functional Requirements

1. FR-1: Validate rating on server. Demonstrate with a reproducible fixture.
2. FR-2: save feedback. Demonstrate with a reproducible fixture.
3. FR-3: show confirmed receipt. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Invalid rating creates no record.

## Expected Output

Invalid rating creates no record. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate rating on server. For an industry exercise, write a recovery and handoff note identifying operational limits.
