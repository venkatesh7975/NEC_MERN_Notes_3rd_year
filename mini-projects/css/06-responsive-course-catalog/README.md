...
ID: CSS-06. Status: specification ready; solution not supplied.
...
Build readable layouts that adapt to narrow and wide screens. Apply this by building responsive course catalog and explaining the acceptance example.

## Problem Statement

Build responsive course catalog for a fictional college learning environment. The deliverable must demonstrate the specific behavior below using small reproducible fixtures. Use fictional records only.

## Features

- Use one, two and three columns at 360, 768 and 1280px.
- test long titles.

## Functional Requirements

1. FR-1: Use one, two and three columns at 360, 768 and 1280px. Provide an observation or test that proves this behavior.
2. FR-2: test long titles. Provide an observation or test that proves this behavior.
...
Prepare the fixture or interaction in this acceptance scenario: Nine cards remain readable at all three widths.

## Expected Output

Acceptance oracle: Nine cards remain readable at all three widths. Record the actual result next to the expected result in your test evidence.
...
Add one contrasting fixture that stresses the main invariant: use one, two and three columns at 360, 768 and 1280px. Compare the two results in a short design note. For Industry projects, include operational limits and recovery steps in the handoff.

## Interview Questions

1. How does use one, two and three columns at 360, 768 and 1280px work in your solution?
