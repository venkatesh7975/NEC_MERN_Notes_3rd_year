# Bounded upload exercise

ID: EXPRESS-08. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement bounded upload exercise. Explain the acceptance example from input to result.

## Problem Statement

Build bounded upload exercise for a fictional college environment. Accept one text file; limit size; generate storage names.
...
1. FR-1: Accept one text file. Demonstrate with a reproducible fixture.
2. FR-2: limit size. Demonstrate with a reproducible fixture.
3. FR-3: generate storage names. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Oversized input returns 413 without storing a file.

## Expected Output

Oversized input returns 413 without storing a file. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: accept one text file. For an industry exercise, write a recovery and handoff note identifying operational limits.
