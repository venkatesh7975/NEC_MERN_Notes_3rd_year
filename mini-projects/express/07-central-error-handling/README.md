...
ID: EXPRESS-07. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement central error handling. Explain the acceptance example from input to result.

## Problem Statement

Build central error handling for a fictional college environment. Handle malformed JSON and rejected operations; avoid stack traces in responses.

## Features

- Handle malformed JSON and rejected operations.
- avoid stack traces in responses.

## Functional Requirements

1. FR-1: Handle malformed JSON and rejected operations. Demonstrate with a reproducible fixture.
2. FR-2: avoid stack traces in responses. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Malformed JSON returns 400; unexpected failure returns 500.

## Expected Output

Malformed JSON returns 400; unexpected failure returns 500. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: handle malformed json and rejected operations. For an industry exercise, write a recovery and handoff note identifying operational limits.
