# Middleware contract harness

ID: EXPRESS-10. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement middleware contract harness. Explain the acceptance example from input to result.

## Problem Statement

Build middleware contract harness for a fictional college environment. Verify parser ordering and error forwarding; prevent double responses.

## Features

- Verify parser ordering and error forwarding.
- prevent double responses.

## Functional Requirements

1. FR-1: Verify parser ordering and error forwarding. Demonstrate with a reproducible fixture.
2. FR-2: prevent double responses. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Invalid input never reaches the write handler.

## Expected Output

Invalid input never reaches the write handler. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: verify parser ordering and error forwarding. For an industry exercise, write a recovery and handoff note identifying operational limits.
