...
ID: EXPRESS-06. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement enrollment router. Explain the acceptance example from input to result.

## Problem Statement

Build enrollment router for a fictional college environment. Mount a router under /api/enrollments; validate IDs and body; handle unknown routes.

## Features

- Mount a router under /api/enrollments.
- validate IDs and body.
- handle unknown routes.

## Functional Requirements

1. FR-1: Mount a router under /api/enrollments. Demonstrate with a reproducible fixture.
2. FR-2: validate IDs and body. Demonstrate with a reproducible fixture.
3. FR-3: handle unknown routes. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Wrong prefix returns 404.

## Expected Output

Wrong prefix returns 404. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: mount a router under /api/enrollments. For an industry exercise, write a recovery and handoff note identifying operational limits.
