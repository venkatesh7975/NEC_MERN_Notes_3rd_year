...
ID: EXPRESS-01. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement course listing route. Explain the acceptance example from input to result.

## Problem Statement

Build course listing route for a fictional college environment. Return three fixture courses; add a health route.

## Features

- Return three fixture courses.
- add a health route.

## Functional Requirements

1. FR-1: Return three fixture courses. Demonstrate with a reproducible fixture.
2. FR-2: add a health route. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: GET /courses returns 200 with three records.

## Expected Output

GET /courses returns 200 with three records. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: return three fixture courses. For an industry exercise, write a recovery and handoff note identifying operational limits.
