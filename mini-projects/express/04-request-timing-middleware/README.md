...
ID: EXPRESS-04. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement request timing middleware. Explain the acceptance example from input to result.

## Problem Statement

Build request timing middleware for a fictional college environment. Assign request IDs; log timing once after finish; exclude sensitive bodies.

## Features

- Assign request IDs.
- log timing once after finish.
- exclude sensitive bodies.

## Functional Requirements

1. FR-1: Assign request IDs. Demonstrate with a reproducible fixture.
2. FR-2: log timing once after finish. Demonstrate with a reproducible fixture.
3. FR-3: exclude sensitive bodies. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Each request generates one completion record.

## Expected Output

Each request generates one completion record. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: assign request ids. For an industry exercise, write a recovery and handoff note identifying operational limits.
