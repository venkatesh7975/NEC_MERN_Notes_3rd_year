...
ID: EXPRESS-09. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement rate-limited feedback. Explain the acceptance example from input to result.

## Problem Statement

Build rate-limited feedback for a fictional college environment. Validate feedback; configure request limit and reset; document proxy assumptions.

## Features

- Validate feedback.
- configure request limit and reset.
- document proxy assumptions.

## Functional Requirements

1. FR-1: Validate feedback. Demonstrate with a reproducible fixture.
2. FR-2: configure request limit and reset. Demonstrate with a reproducible fixture.
3. FR-3: document proxy assumptions. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Requests above configured limit return 429.

## Expected Output

Requests above configured limit return 429. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate feedback. For an industry exercise, write a recovery and handoff note identifying operational limits.
