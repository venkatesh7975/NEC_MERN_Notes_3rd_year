...
ID: EXPRESS-02. Status: specification ready; solution not supplied.
...
Apply routing, middleware, static files, errors to implement parameter lookup. Explain the acceptance example from input to result.

## Problem Statement

Build parameter lookup for a fictional college environment. Validate positive integer IDs; handle missing records.
...
1. FR-1: Validate positive integer IDs. Demonstrate with a reproducible fixture.
2. FR-2: handle missing records. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: abc returns 400; missing numeric ID returns 404.

## Expected Output

abc returns 400; missing numeric ID returns 404. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate positive integer ids. For an industry exercise, write a recovery and handoff note identifying operational limits.
