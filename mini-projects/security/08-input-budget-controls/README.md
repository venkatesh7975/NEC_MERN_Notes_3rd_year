# Input budget controls

ID: SECURITY-08. Status: specification ready; solution not supplied.
...
Apply owasp basics, sql injection, xss, csrf to implement input budget controls. Explain the acceptance example from input to result.

## Problem Statement

Build input budget controls for a fictional college environment. Bound body size array length and numeric range.

## Features

- Bound body size array length and numeric range.

## Functional Requirements

1. FR-1: Bound body size array length and numeric range. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Oversized input rejected explicitly.

## Expected Output

Oversized input rejected explicitly. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: bound body size array length and numeric range. For an industry exercise, write a recovery and handoff note identifying operational limits.
