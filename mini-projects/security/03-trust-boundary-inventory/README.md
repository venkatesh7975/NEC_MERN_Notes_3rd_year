...
ID: SECURITY-03. Status: specification ready; solution not supplied.
...
Apply owasp basics, sql injection, xss, csrf to implement trust boundary inventory. Explain the acceptance example from input to result.

## Problem Statement

Build trust boundary inventory for a fictional college environment. Trace form API storage; annotate server validation; implement one boundary check.

## Features

- Trace form API storage.
- annotate server validation.
- implement one boundary check.

## Functional Requirements

1. FR-1: Trace form API storage. Demonstrate with a reproducible fixture.
2. FR-2: annotate server validation. Demonstrate with a reproducible fixture.
3. FR-3: implement one boundary check. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Invalid value is rejected at the server.

## Expected Output

Invalid value is rejected at the server. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: trace form api storage. For an industry exercise, write a recovery and handoff note identifying operational limits.
