# Rendering boundary lab

ID: SECURITY-04. Status: specification ready; solution not supplied.
...
Apply owasp basics, sql injection, xss, csrf to implement rendering boundary lab. Explain the acceptance example from input to result.

## Problem Statement

Build rendering boundary lab for a fictional college environment. Use context-appropriate encoding; disallow unsupported rich HTML.

## Features

- Use context-appropriate encoding.
- disallow unsupported rich HTML.

## Functional Requirements

1. FR-1: Use context-appropriate encoding. Demonstrate with a reproducible fixture.
2. FR-2: disallow unsupported rich HTML. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Untrusted markup remains inert.

## Expected Output

Untrusted markup remains inert. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: use context-appropriate encoding. For an industry exercise, write a recovery and handoff note identifying operational limits.
