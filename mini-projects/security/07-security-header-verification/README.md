...
ID: SECURITY-07. Status: specification ready; solution not supplied.
...
Apply owasp basics, sql injection, xss, csrf to implement security header verification. Explain the acceptance example from input to result.

## Problem Statement

Build security header verification for a fictional college environment. Apply restrictive script policy locally; inspect actual headers.

## Features

- Apply restrictive script policy locally.
- inspect actual headers.

## Functional Requirements

1. FR-1: Apply restrictive script policy locally. Demonstrate with a reproducible fixture.
2. FR-2: inspect actual headers. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Unapproved inline script blocked.

## Expected Output

Unapproved inline script blocked. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: apply restrictive script policy locally. For an industry exercise, write a recovery and handoff note identifying operational limits.
