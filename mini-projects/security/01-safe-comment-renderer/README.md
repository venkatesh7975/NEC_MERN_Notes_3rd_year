...
ID: SECURITY-01. Status: specification ready; solution not supplied.
...
Apply owasp basics, sql injection, xss, csrf to implement safe comment renderer. Explain the acceptance example from input to result.

## Problem Statement

Build safe comment renderer for a fictional college environment. Display text through textContent; test literal markup.

## Features

- Display text through textContent.
- test literal markup.

## Functional Requirements

1. FR-1: Display text through textContent. Demonstrate with a reproducible fixture.
2. FR-2: test literal markup. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: <b>hello</b> appears literally.

## Expected Output

<b>hello</b> appears literally. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: display text through textcontent. For an industry exercise, write a recovery and handoff note identifying operational limits.
