...
ID: MONGODB-09. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement data import validator. Explain the acceptance example from input to result.

## Problem Statement

Build data import validator for a fictional college environment. Validate fixtures before insertion; report row errors.

## Features

- Validate fixtures before insertion.
- report row errors.

## Functional Requirements

1. FR-1: Validate fixtures before insertion. Demonstrate with a reproducible fixture.
2. FR-2: report row errors. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Missing code rejected while valid rows import.

## Expected Output

Missing code rejected while valid rows import. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate fixtures before insertion. For an industry exercise, write a recovery and handoff note identifying operational limits.
