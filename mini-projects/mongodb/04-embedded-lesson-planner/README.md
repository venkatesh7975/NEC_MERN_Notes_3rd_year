# Embedded lesson planner

ID: MONGODB-04. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement embedded lesson planner. Explain the acceptance example from input to result.

## Problem Statement

Build embedded lesson planner for a fictional college environment. Store bounded lesson arrays; query nested fields.

## Features

- Store bounded lesson arrays.
- query nested fields.

## Functional Requirements

1. FR-1: Store bounded lesson arrays. Demonstrate with a reproducible fixture.
2. FR-2: query nested fields. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Forms lesson matches the correct course.

## Expected Output

Forms lesson matches the correct course. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: store bounded lesson arrays. For an industry exercise, write a recovery and handoff note identifying operational limits.
