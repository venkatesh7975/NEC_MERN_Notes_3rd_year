...
ID: MONGODB-05. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement reference design comparison. Explain the acceptance example from input to result.

## Problem Statement

Build reference design comparison for a fictional college environment. Model enrollment with references and embedding; compare reads.

## Features

- Model enrollment with references and embedding.
- compare reads.

## Functional Requirements

1. FR-1: Model enrollment with references and embedding. Demonstrate with a reproducible fixture.
2. FR-2: compare reads. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Both models answer the same enrollment question.

## Expected Output

Both models answer the same enrollment question. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: model enrollment with references and embedding. For an industry exercise, write a recovery and handoff note identifying operational limits.
