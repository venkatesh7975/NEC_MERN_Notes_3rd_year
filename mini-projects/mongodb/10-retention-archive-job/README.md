...
ID: MONGODB-10. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement retention archive job. Explain the acceptance example from input to result.

## Problem Statement

Build retention archive job for a fictional college environment. Select cutoff records; export and verify counts; default to dry run.

## Features

- Select cutoff records.
- export and verify counts.
- default to dry run.

## Functional Requirements

1. FR-1: Select cutoff records. Demonstrate with a reproducible fixture.
2. FR-2: export and verify counts. Demonstrate with a reproducible fixture.
3. FR-3: default to dry run. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Dry run lists IDs without deletion.

## Expected Output

Dry run lists IDs without deletion. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: select cutoff records. For an industry exercise, write a recovery and handoff note identifying operational limits.
