...
ID: MONGODB-03. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement targeted update lab. Explain the acceptance example from input to result.

## Problem Statement

Build targeted update lab for a fictional college environment. Use a precise filter and $set; verify unrelated document.

## Features

- Use a precise filter and $set.
- verify unrelated document.

## Functional Requirements

1. FR-1: Use a precise filter and $set. Demonstrate with a reproducible fixture.
2. FR-2: verify unrelated document. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: CSS remains unchanged after updating HTML.

## Expected Output

CSS remains unchanged after updating HTML. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: use a precise filter and $set. For an industry exercise, write a recovery and handoff note identifying operational limits.
