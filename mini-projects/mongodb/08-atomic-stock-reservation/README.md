...
ID: MONGODB-08. Status: specification ready; solution not supplied.
...
Apply documents, collections, crud, modeling to implement atomic stock reservation. Explain the acceptance example from input to result.

## Problem Statement

Build atomic stock reservation for a fictional college environment. Condition update on positive stock; decrement atomically.

## Features

- Condition update on positive stock.
- decrement atomically.

## Functional Requirements

1. FR-1: Condition update on positive stock. Demonstrate with a reproducible fixture.
2. FR-2: decrement atomically. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Stock 1 permits one successful reservation.

## Expected Output

Stock 1 permits one successful reservation. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: condition update on positive stock. For an industry exercise, write a recovery and handoff note identifying operational limits.
