...
ID: REACT-05. Status: specification ready; solution not supplied.
...
Apply jsx, components, props, state, events to implement searchable module list. Explain the acceptance example from input to result.

## Problem Statement

Build searchable module list for a fictional college environment. Filter by controlled text input; derive results without mutating source.

## Features

- Filter by controlled text input.
- derive results without mutating source.

## Functional Requirements

1. FR-1: Filter by controlled text input. Demonstrate with a reproducible fixture.
2. FR-2: derive results without mutating source. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Clearing search restores all modules.

## Expected Output

Clearing search restores all modules. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: filter by controlled text input. For an industry exercise, write a recovery and handoff note identifying operational limits.
