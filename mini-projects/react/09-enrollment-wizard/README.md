...
ID: REACT-09. Status: specification ready; solution not supplied.
...
Apply jsx, components, props, state, events to implement enrollment wizard. Explain the acceptance example from input to result.

## Problem Statement

Build enrollment wizard for a fictional college environment. Implement three steps with validation and review; preserve values on back navigation.

## Features

- Implement three steps with validation and review.
- preserve values on back navigation.

## Functional Requirements

1. FR-1: Implement three steps with validation and review. Demonstrate with a reproducible fixture.
2. FR-2: preserve values on back navigation. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Back from review retains contact values.

## Expected Output

Back from review retains contact values. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: implement three steps with validation and review. For an industry exercise, write a recovery and handoff note identifying operational limits.
