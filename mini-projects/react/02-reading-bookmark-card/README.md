...
ID: REACT-02. Status: specification ready; solution not supplied.
...
Apply jsx, components, props, state, events to implement reading bookmark card. Explain the acceptance example from input to result.

## Problem Statement

Build reading bookmark card for a fictional college environment. Toggle saved state; expose aria-pressed.
...
1. FR-1: Toggle saved state. Demonstrate with a reproducible fixture.
2. FR-2: expose aria-pressed. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Two clicks return to unsaved.

## Expected Output

Two clicks return to unsaved. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: toggle saved state. For an industry exercise, write a recovery and handoff note identifying operational limits.
