...
ID: REACT-03. Status: specification ready; solution not supplied.
...
Apply jsx, components, props, state, events to implement seat availability panel. Explain the acceptance example from input to result.

## Problem Statement

Build seat availability panel for a fictional college environment. Change available seats between 0 and 30; disable controls at bounds.

## Features

- Change available seats between 0 and 30.
- disable controls at bounds.

## Functional Requirements

1. FR-1: Change available seats between 0 and 30. Demonstrate with a reproducible fixture.
2. FR-2: disable controls at bounds. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Increment at 30 keeps 30.

## Expected Output

Increment at 30 keeps 30. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: change available seats between 0 and 30. For an industry exercise, write a recovery and handoff note identifying operational limits.
