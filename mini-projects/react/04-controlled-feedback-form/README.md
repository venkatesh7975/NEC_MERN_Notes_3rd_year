...
ID: REACT-04. Status: specification ready; solution not supplied.
...
Apply jsx, components, props, state, events to implement controlled feedback form. Explain the acceptance example from input to result.

## Problem Statement

Build controlled feedback form for a fictional college environment. Validate required name and rating 1–5; reset after local submission.

## Features

- Validate required name and rating 1–5.
- reset after local submission.

## Functional Requirements

1. FR-1: Validate required name and rating 1–5. Demonstrate with a reproducible fixture.
2. FR-2: reset after local submission. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Blank name prevents submission.

## Expected Output

Blank name prevents submission. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: validate required name and rating 1–5. For an industry exercise, write a recovery and handoff note identifying operational limits.
