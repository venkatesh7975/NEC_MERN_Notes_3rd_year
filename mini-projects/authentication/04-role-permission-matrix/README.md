...
ID: AUTHENTICATION-04. Status: specification ready; solution not supplied.
...
Apply passwords, sessions, identity, ownership, roles to implement role permission matrix. Explain the acceptance example from input to result.

## Problem Statement

Build role permission matrix for a fictional college environment. Define learner and faculty permissions; enforce server-side.

## Features

- Define learner and faculty permissions.
- enforce server-side.

## Functional Requirements

1. FR-1: Define learner and faculty permissions. Demonstrate with a reproducible fixture.
2. FR-2: enforce server-side. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Learner cannot create assessment.

## Expected Output

Learner cannot create assessment. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: define learner and faculty permissions. For an industry exercise, write a recovery and handoff note identifying operational limits.
