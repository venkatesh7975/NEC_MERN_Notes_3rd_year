...
ID: AUTHENTICATION-08. Status: specification ready; solution not supplied.
...
Apply passwords, sessions, identity, ownership, roles to implement session inventory. Explain the acceptance example from input to result.

## Problem Statement

Build session inventory for a fictional college environment. List sessions without raw tokens; revoke individual sessions.

## Features

- List sessions without raw tokens.
- revoke individual sessions.

## Functional Requirements

1. FR-1: List sessions without raw tokens. Demonstrate with a reproducible fixture.
2. FR-2: revoke individual sessions. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Revoked session loses access.

## Expected Output

Revoked session loses access. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: list sessions without raw tokens. For an industry exercise, write a recovery and handoff note identifying operational limits.
