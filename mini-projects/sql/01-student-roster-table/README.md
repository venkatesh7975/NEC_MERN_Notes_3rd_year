...
ID: SQL-01. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement student roster table. Explain the acceptance example from input to result.

## Problem Statement

Build student roster table for a fictional college environment. Define primary key; seed three fictional students; query by ID.

## Features

- Define primary key.
- seed three fictional students.
- query by ID.

## Functional Requirements

1. FR-1: Define primary key. Demonstrate with a reproducible fixture.
2. FR-2: seed three fictional students. Demonstrate with a reproducible fixture.
3. FR-3: query by ID. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Three seeded rows appear in ID order.

## Expected Output

Three seeded rows appear in ID order. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: define primary key. For an industry exercise, write a recovery and handoff note identifying operational limits.
