...
ID: SQL-09. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement enrollment reconciliation. Explain the acceptance example from input to result.

## Problem Statement

Build enrollment reconciliation for a fictional college environment. Detect duplicates and orphan candidates in staging data; report without modifying.

## Features

- Detect duplicates and orphan candidates in staging data.
- report without modifying.

## Functional Requirements

1. FR-1: Detect duplicates and orphan candidates in staging data. Demonstrate with a reproducible fixture.
2. FR-2: report without modifying. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Duplicate pairs appear in a report; source remains unchanged.

## Expected Output

Duplicate pairs appear in a report; source remains unchanged. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: detect duplicates and orphan candidates in staging data. For an industry exercise, write a recovery and handoff note identifying operational limits.
