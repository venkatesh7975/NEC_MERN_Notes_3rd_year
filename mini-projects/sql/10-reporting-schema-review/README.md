# Reporting schema review

ID: SQL-10. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement reporting schema review. Explain the acceptance example from input to result.

## Problem Statement

Build reporting schema review for a fictional college environment. Design students courses enrollments; document keys; verify query plans.

## Features

- Design students courses enrollments.
- document keys.
- verify query plans.

## Functional Requirements

1. FR-1: Design students courses enrollments. Demonstrate with a reproducible fixture.
2. FR-2: document keys. Demonstrate with a reproducible fixture.
3. FR-3: verify query plans. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Reports run against reproducible seeds.

## Expected Output

Reports run against reproducible seeds. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: design students courses enrollments. For an industry exercise, write a recovery and handoff note identifying operational limits.
