...
ID: SQL-04. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement instructor inner join. Explain the acceptance example from input to result.

## Problem Statement

Build instructor inner join for a fictional college environment. Join courses and instructors; seed an instructor without a course.

## Features

- Join courses and instructors.
- seed an instructor without a course.

## Functional Requirements

1. FR-1: Join courses and instructors. Demonstrate with a reproducible fixture.
2. FR-2: seed an instructor without a course. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Only matched instructors appear.

## Expected Output

Only matched instructors appear. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: join courses and instructors. For an industry exercise, write a recovery and handoff note identifying operational limits.
