# Marks aggregate report

ID: SQL-06. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement marks aggregate report. Explain the acceptance example from input to result.

## Problem Statement

Build marks aggregate report for a fictional college environment. Group marks by course; distinguish NULL and zero; compute average.

## Features

- Group marks by course.
- distinguish NULL and zero.
- compute average.

## Functional Requirements

1. FR-1: Group marks by course. Demonstrate with a reproducible fixture.
2. FR-2: distinguish NULL and zero. Demonstrate with a reproducible fixture.
3. FR-3: compute average. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: 0,100,NULL produce average 50.

## Expected Output

0,100,NULL produce average 50. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: group marks by course. For an industry exercise, write a recovery and handoff note identifying operational limits.
