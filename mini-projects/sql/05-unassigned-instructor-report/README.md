# Unassigned instructor report

ID: SQL-05. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement unassigned instructor report. Explain the acceptance example from input to result.

## Problem Statement

Build unassigned instructor report for a fictional college environment. Use LEFT JOIN; count course IDs instead of star.

## Features

- Use LEFT JOIN.
- count course IDs instead of star.

## Functional Requirements

1. FR-1: Use LEFT JOIN. Demonstrate with a reproducible fixture.
2. FR-2: count course IDs instead of star. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: An instructor without courses has count 0.

## Expected Output

An instructor without courses has count 0. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: use left join. For an industry exercise, write a recovery and handoff note identifying operational limits.
