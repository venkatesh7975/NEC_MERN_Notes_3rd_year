...
ID: SQL-03. Status: specification ready; solution not supplied.
...
Apply sql versus nosql, crud, keys, joins to implement unique enrollment constraint. Explain the acceptance example from input to result.

## Problem Statement

Build unique enrollment constraint for a fictional college environment. Model student-course relation; add composite uniqueness.

## Features

- Model student-course relation.
- add composite uniqueness.

## Functional Requirements

1. FR-1: Model student-course relation. Demonstrate with a reproducible fixture.
2. FR-2: add composite uniqueness. Demonstrate with a reproducible fixture.
...
Prepare the fixture and interaction needed for this scenario: Duplicate enrollment pair is rejected.

## Expected Output

Duplicate enrollment pair is rejected. Record actual results beside this expectation.
...
Add a contrasting fixture for the main operation: model student-course relation. For an industry exercise, write a recovery and handoff note identifying operational limits.
